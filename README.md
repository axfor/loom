...
```
make release V=v1.0.0     lm for five platforms + the extension + SHA256SUMS, into dist/
git tag v1.0.0 && git push origin v1.0.0    publishes it (the workflow builds and attaches dist/)
```
