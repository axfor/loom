...
```
make release V=v1.0.4     lm for five platforms + the extension + SHA256SUMS, into dist/
git tag v1.0.4 && git push origin v1.0.4    publishes it (the workflow builds and attaches dist/)
```
