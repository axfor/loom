...
```
make release V=v1.0.1     lm for five platforms + the extension + SHA256SUMS, into dist/
git tag v1.0.1 && git push origin v1.0.1    publishes it (the workflow builds and attaches dist/)
```
